...
function loadSlides() {
    ...
    const slideNumbers = [
        ...
        65, 67, 69, 70, 71, 73, 75, 77, 79, 81, 82, '82+1', 83, 84, 85, 86, 87, 88,
        90, 91, 92, 93, 94, 97, 98, 99, 100, 101, 104, 105, 106, 107, 108,
        110, '110+1', 111, 112, 113, 114
    ];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelector('.nav.links').addEventListener('click', () => showOverlay('Posilanna/Посилання.webp'));
